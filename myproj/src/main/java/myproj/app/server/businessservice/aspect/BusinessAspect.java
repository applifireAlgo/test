package myproj.app.server.businessservice.aspect;
...
public class BusinessAspect {
    ...
    @Before("execution(* myproj.app.server.repository.*Impl.save(..))")
    public void beforeSaveAdvice(JoinPoint joinPoint) throws SpartanConstraintViolationException {
        Object obj[] = joinPoint.getArgs();
    }

    @After("execution(* myproj.app.server.businessservice..*(..))")
