...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for AppCustomerCategory Master table Entity", complexity = Complexity.LOW)
public class AppCustomerCategoryRepositoryImpl extends SearchInterfaceImpl implements AppCustomerCategoryRepository<AppCustomerCategory> {
    ...
    @Override
    @Transactional
    public List<AppCustomerCategory> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<myproj.app.shared.customers.AppCustomerCategory> query = emanager.createQuery("select u from AppCustomerCategory u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public AppCustomerCategory save(AppCustomerCategory entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<AppCustomerCategory> save(List<AppCustomerCategory> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.customers.AppCustomerCategory obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            myproj.app.shared.customers.AppCustomerCategory s = emanager.find(myproj.app.shared.customers.AppCustomerCategory.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(AppCustomerCategory entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<AppCustomerCategory> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.customers.AppCustomerCategory obj = entity.get(i);
    ...
    @Transactional
    public AppCustomerCategory findById(String appcustCategoryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("AppCustomerCategory.findById");
            query.setParameter("appcustCategoryId", appcustCategoryId);
            myproj.app.shared.customers.AppCustomerCategory listOfAppCustomerCategory = (myproj.app.shared.customers.AppCustomerCategory) query.getSingleResult();
