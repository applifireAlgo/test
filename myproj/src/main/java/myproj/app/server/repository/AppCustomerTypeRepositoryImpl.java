...
public class AppCustomerTypeRepositoryImpl extends SearchInterfaceImpl implements AppCustomerTypeRepository<AppCustomerType> {
    ...
    @Override
    @Transactional
    public List<AppCustomerType> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<myproj.app.shared.customers.AppCustomerType> query = emanager.createQuery("select u from AppCustomerType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public AppCustomerType save(AppCustomerType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<AppCustomerType> save(List<AppCustomerType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.customers.AppCustomerType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            myproj.app.shared.customers.AppCustomerType s = emanager.find(myproj.app.shared.customers.AppCustomerType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(AppCustomerType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<AppCustomerType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.customers.AppCustomerType obj = entity.get(i);
    ...
    @Transactional
    public AppCustomerType findById(String appcustTypeId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("AppCustomerType.findById");
            query.setParameter("appcustTypeId", appcustTypeId);
            myproj.app.shared.customers.AppCustomerType listOfAppCustomerType = (myproj.app.shared.customers.AppCustomerType) query.getSingleResult();
