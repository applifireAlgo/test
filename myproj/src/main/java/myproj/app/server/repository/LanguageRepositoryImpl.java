...
public class LanguageRepositoryImpl extends SearchInterfaceImpl implements LanguageRepository<Language> {
    ...
    public List<Language> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<myproj.app.shared.location.Language> query = emanager.createQuery("select u from Language u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Language save(Language entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Language> save(List<Language> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.location.Language obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            myproj.app.shared.location.Language s = emanager.find(myproj.app.shared.location.Language.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Language entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Language> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.location.Language obj = entity.get(i);
    ...
    public Language findById(String languageId) throws Exception, SpartanPersistenceException {
        try {
            ...
            myproj.app.shared.location.Language listOfLanguage = (myproj.app.shared.location.Language) query.getSingleResult();
