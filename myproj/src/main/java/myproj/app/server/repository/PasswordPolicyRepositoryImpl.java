...
import myproj.app.shared.authentication.PasswordPolicy;
...
public class PasswordPolicyRepositoryImpl extends SearchInterfaceImpl implements PasswordPolicyRepository<PasswordPolicy> {
    ...
    @Transactional
    public PasswordPolicyInterface findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.spartan.shield.server.authentication.interfaces.PasswordPolicyInterface query = (com.spartan.shield.server.authentication.interfaces.PasswordPolicyInterface) emanager.createQuery("select u from PasswordPolicy u").getSingleResult();
            return query;
    ...
    @Override
    @Transactional
    public PasswordPolicy save(PasswordPolicy entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<PasswordPolicy> save(List<PasswordPolicy> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.authentication.PasswordPolicy obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            myproj.app.shared.authentication.PasswordPolicy s = emanager.find(myproj.app.shared.authentication.PasswordPolicy.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(PasswordPolicy entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<PasswordPolicy> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.authentication.PasswordPolicy obj = entity.get(i);
    ...
    public PasswordPolicy findById(String policyId) throws Exception, SpartanPersistenceException {
        try {
            ...
            myproj.app.shared.authentication.PasswordPolicy listOfPasswordPolicy = (myproj.app.shared.authentication.PasswordPolicy) query.getSingleResult();
