...
public class TimezoneRepositoryImpl extends SearchInterfaceImpl implements TimezoneRepository<Timezone> {
    ...
    public List<Timezone> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<myproj.app.shared.location.Timezone> query = emanager.createQuery("select u from Timezone u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Timezone save(Timezone entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Timezone> save(List<Timezone> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.location.Timezone obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            myproj.app.shared.location.Timezone s = emanager.find(myproj.app.shared.location.Timezone.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Timezone entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Timezone> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.location.Timezone obj = entity.get(i);
    ...
    public Timezone findById(String timeZoneId) throws Exception, SpartanPersistenceException {
        try {
            ...
            myproj.app.shared.location.Timezone listOfTimezone = (myproj.app.shared.location.Timezone) query.getSingleResult();
