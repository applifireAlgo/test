...
public class UserAccessDomainRepositoryImpl extends SearchInterfaceImpl implements UserAccessDomainRepository<UserAccessDomain> {
    ...
    public List<UserAccessDomain> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<myproj.app.shared.authentication.UserAccessDomain> query = emanager.createQuery("select u from UserAccessDomain u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public UserAccessDomain save(UserAccessDomain entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<UserAccessDomain> save(List<UserAccessDomain> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.authentication.UserAccessDomain obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            myproj.app.shared.authentication.UserAccessDomain s = emanager.find(myproj.app.shared.authentication.UserAccessDomain.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(UserAccessDomain entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<UserAccessDomain> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                myproj.app.shared.authentication.UserAccessDomain obj = entity.get(i);
    ...
    public UserAccessDomain findById(String userAccessDomainId) throws Exception, SpartanPersistenceException {
        try {
            ...
            myproj.app.shared.authentication.UserAccessDomain listOfUserAccessDomain = (myproj.app.shared.authentication.UserAccessDomain) query.getSingleResult();
