package myproj.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* myproj.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* myproj.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* myproj.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* myproj.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* myproj.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* myproj.app.server.repository..*(..))")
