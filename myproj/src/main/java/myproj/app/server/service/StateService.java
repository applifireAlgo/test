...
public abstract class StateService {
    ...
    public HttpEntity<ResponseBean> save(State entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> save(List<State> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
    ...
    public HttpEntity<ResponseBean> update(State entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> update(List<State> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
