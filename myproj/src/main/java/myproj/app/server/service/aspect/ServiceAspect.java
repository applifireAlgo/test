...
public class ServiceAspect {
    ...
    @Pointcut("execution(* myproj.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* myproj.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* myproj.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* myproj.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* myproj.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* myproj.app.server.service..get*(..))")
