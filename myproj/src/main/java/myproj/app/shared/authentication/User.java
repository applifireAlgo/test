package myproj.app.shared.authentication;
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<myproj.app.shared.authentication.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            myproj.app.shared.authentication.User other = (myproj.app.shared.authentication.User) obj;
            if (userId == null) {
                return false;
