package myproj.app.shared.authorization;
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<myproj.app.shared.authorization.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            myproj.app.shared.authorization.Roles other = (myproj.app.shared.authorization.Roles) obj;
            if (roleId == null) {
                return false;
