package myproj.app.shared.contacts;
...
import myproj.app.shared.EntityAudit;
import myproj.app.shared.SystemInfo;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<myproj.app.shared.contacts.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<myproj.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            myproj.app.shared.contacts.CoreContacts other = (myproj.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
