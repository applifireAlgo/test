...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("02vpSrX4Bf3Zua0jFib58V5dr48YfOdr");
            country.setCapitalLatitude(4);
            country.setCapitalLongitude(2);
            country.setCountryCode1("yxB");
            country.setCountryCode2("DBy");
            country.setCountryFlag("NWUccI9CMqVxT66gCEPha84khNqj3isQW3tJzWJMkMP10DPPFx");
            country.setCountryName("96FHxDo9BKZng4o9zS7jdW2HXApfeDSAvENoCFm5vTvfp4bHXD");
            country.setCurrencyCode("BJB");
            country.setCurrencyName("KwScrImG1daeqhSEMl5xMisEEaJ759JSKHQCaSpr7q11Z80nsk");
            country.setCurrencySymbol("h1Fr7L9Pco5WdSqM1Xudv1X0WsXKIFqk");
            country.setIsoNumeric(11);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("SaUbgeuGYNBBXJ8sM4AatGDR90a6pCukmIPVqSb5sp2GYzz68D");
            currency.setUnicodeDecimal("6eQMGthTldvYSGuzkLlVYcCxt6FujftYZD3eythlnh1diNOcgu");
            currency.setUnicodeHex("eeN6LW4IlkIYEotSNq5h51YLzE8kPfkrJORpEVLqPY5U1YZ6Bu");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("ltnMamoPYll7AYviTbBo1LNksqk8CQoKqOZGruQ4r0pc0hCPXb");
            currency.setUnicodeDecimal("YBtOwCxsgM2oUQaqosxkjjJg2gq1lvzYfQpl4f2M921rm10tfd");
            currency.setUnicodeHex("IfeiSG8yI2xhxyQwL7kF7VonuOwRee1UDNmWdJPA4Yz3euobmL");
