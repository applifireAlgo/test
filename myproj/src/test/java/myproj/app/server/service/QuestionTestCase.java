...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("wjds8cevSeP2oihSXqlbAEu3wkPwh4Wtv18w9jkfpL04FzH8DM");
            question.setQuestionDetails("ivx");
            question.setQuestionIcon("owinDS5QvbF76QenJfSTUrkbTMMxFsIaNyj8bXY7fxcjYXoGDa");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("ZJR4jxgpNHOwKaJrZ4MQCSObCDFrSrLTIqFCpMxLEEvYzjxU5P");
            question.setQuestionDetails("win");
            question.setQuestionIcon("rDt8pK8q2YnK8QQxJ1FcDBsDRLI1Kl4wcWAnwSGF5YzMitQBsq");
