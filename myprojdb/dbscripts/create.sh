...
echo $PATH
OSNAME=`uname -s`
DB_PATH=/tmp/applifire/db/Y5ZLTDXILQ4XBUGKBQTEYG
ART_CREATE_PATH=/tmp/applifire/db/Y5ZLTDXILQ4XBUGKBQTEYG/art/create
AST_CREATE_PATH=/tmp/applifire/db/Y5ZLTDXILQ4XBUGKBQTEYG/ast/create
MYSQL=/usr/bin
APPLFIREUSER=root
