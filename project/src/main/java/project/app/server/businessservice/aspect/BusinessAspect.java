package project.app.server.businessservice.aspect;
...
public class BusinessAspect {
    ...
    @Before("execution(* project.app.server.repository.*Impl.save(..))")
    public void beforeSaveAdvice(JoinPoint joinPoint) throws SpartanConstraintViolationException {
        Object obj[] = joinPoint.getArgs();
    }

    @After("execution(* project.app.server.businessservice..*(..))")
