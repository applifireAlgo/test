package project.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* project.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* project.app.server.repository..*(..))")
