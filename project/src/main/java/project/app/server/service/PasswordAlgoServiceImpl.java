...
import project.app.server.repository.PasswordAlgoRepository;
import project.app.shared.authentication.PasswordAlgo;
...
public class PasswordAlgoServiceImpl extends PasswordAlgoService {
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody PasswordAlgo entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<PasswordAlgo> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            passwordAlgorepo.save(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody PasswordAlgo entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<PasswordAlgo> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            passwordAlgorepo.update(entity);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            project.app.shared.authentication.PasswordAlgo lstpasswordalgo = passwordAlgorepo.findById((String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstpasswordalgo);
        } catch (org.springframework.transaction.TransactionException e) {
