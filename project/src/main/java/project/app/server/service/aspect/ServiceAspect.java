...
public class ServiceAspect {
    ...
    @Pointcut("execution(* project.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* project.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project.app.server.service..get*(..))")
