package project.app.shared.authentication;
...
import project.app.shared.EntityAudit;
import project.app.shared.SystemInfo;
...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    public boolean equals(Object obj) {
        try {
            project.app.shared.authentication.Login other = (project.app.shared.authentication.Login) obj;
            if (loginPk == null) {
                return false;
