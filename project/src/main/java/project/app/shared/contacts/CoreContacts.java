package project.app.shared.contacts;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<project.app.shared.contacts.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<project.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            project.app.shared.contacts.CoreContacts other = (project.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
