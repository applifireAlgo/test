Ext.define('Project.view.art.masterform.MasterPanelController', {
	     ...
	     Ext.Ajax.request(
 	             {
 	                 ...
 	                 success : function(response,currentObject){
 	                	 ...
 	                	 debugger;
 	                	  var masterFormPanelViewModel = Ext.create('Project.view.art.masterform.MasterFormViewModel');
 	                	  ...
 	                	  var newFormPanelViewModel = Ext.create('Project.view.art.masterform.MasterFormViewModel');
