Ext.define('Project.view.fw.frameworkController.FrameworkViewController', {
    ...
    onConsoleClick: function() {
         var window = Ext.create('Project.view.console.ConsoleWindow');
  			...
  			if(item.isListPanel){
  				...
  				var xtype = item.xtype;
  	   			...
  	   			if(xtype == 'panel' ||  xtype == "fieldset" || xtype == "form"){
  	   				...
  	   				{
  	   					this.addBinableLevelData(json, item, 1);
  	   				}else if(xtype == 'checkboxsgroups' ) {
  	   					this.addBinableLevelData(json, item, 2);
  	   				} else if(xtype == "grids") {
  	   					this.addBinableLevelData(json, item, 2);
  	    			}
  	   			}
    ...
    /** Adding data to json as per bindable level */
     addBinableLevelData : function(level, item, type){
