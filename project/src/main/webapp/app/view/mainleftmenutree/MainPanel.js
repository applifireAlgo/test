Ext.define('Project.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Project.view.resource.ResourcePanel',
			'Project.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Project.view.resource.DockedResourcePanel','Project.view.fw.mainViewPanel.MainPanelController' ],
