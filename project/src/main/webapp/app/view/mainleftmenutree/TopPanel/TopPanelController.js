Ext.define('Project.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Project.view.scheduler.scheduler"
		var component = Ext.create(
				"Project.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Project.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
