Ext.define('Project.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Project.view.mobileview.reportui.datachart.chart.RatingField','Project.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
