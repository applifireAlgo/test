Ext.define('Project.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Project.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Project.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Project.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Project.view.querybuildernewmodel.querydetail.QueryDetail');
