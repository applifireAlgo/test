Ext.define('Project.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Project.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Project.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Project.view.querybuildernewmodel.floatingentity.EntitySprite',
