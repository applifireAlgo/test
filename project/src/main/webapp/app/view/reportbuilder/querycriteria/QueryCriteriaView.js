Ext.define('Project.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Project.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Project.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Project.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Project.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
