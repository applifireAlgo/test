Ext.define('Project.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Project.view.reportui.datachart.chart.RatingField','Project.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
