Ext
		.define(
				'Project.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Project.view.searchengine.search.SearchEngineMainPanelController','Project.view.searchengine.search.PanelHeaderField' ,'Project.view.searchengine.search.ReportGridView','Project.view.searchengine.search.ReportChartView','Project.view.searchengine.search.documentView','Project.view.searchengine.search.DouMeanView','Project.view.googlemaps.map.MapPanel'],
