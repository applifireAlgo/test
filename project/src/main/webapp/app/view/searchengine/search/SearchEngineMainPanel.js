Ext.define('Project.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	alias : [ 'layout.accordion' ],
	xtype : 'solrsearchmainpanel',
	

	requires : ['Project.view.searchengine.search.NorthPanel', 'Project.view.searchengine.search.SearchResult','Project.view.searchengine.search.SearchEngineMainPanelController'],
