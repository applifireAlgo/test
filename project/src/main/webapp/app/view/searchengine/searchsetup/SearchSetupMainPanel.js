 ...
 * 
 */
Ext.define('Project.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Project.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Project.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
