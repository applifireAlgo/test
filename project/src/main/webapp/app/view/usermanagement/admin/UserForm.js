Ext.define('Project.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Project.view.usermanagement.admin.AddUserDetailsViewModel', 'Project.model.AddUserDataModel' ],
