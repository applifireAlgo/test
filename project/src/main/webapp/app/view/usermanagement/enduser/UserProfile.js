Ext.define('Project.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Project.view.usermanagement.enduser.UserProfileController', 'Project.view.usermanagement.admin.AddUserDetailsViewModel', 'Project.model.AddUserDataModel' ],
