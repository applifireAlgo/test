...
public class AppCustomerTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomercategory.setCustomerCategory("9yIoswcofoYlEIJ33DBmAIKL2vI54hW30GrvSlsqSt5ab9WL83");
            ...
            appcustomertype.setCustomerType("QqGFdXC1ZtJpEAs40aiV0PpjoIPNUMU2vw1ogLMMlnPVW7VcEN");
            ...
            corecontacts.setEmailId("Q4zEXqQZ0h5VyMAnILVmKaRZmS9v22ntHz9t9qqhzNYL0nbHhj");
            corecontacts.setFirstName("uKLLKGPhF2fg2GCh84RHaEruNi2zbt5W9tttFlMN7CY49pw30z");
            Gender gender = new Gender();
            gender.setGender("l9yd67dH4RcTDuEN2EblQSiuNqlvRACRgQo016pBBk3txb5Mj8");
            Gender GenderTest = genderRepository.save(gender);
            map.put("GenderPrimaryKey", gender._getPrimarykey());
            Language language = new Language();
            language.setAlpha2("mE");
            language.setAlpha3("e3k");
            language.setAlpha4("RRsI");
            language.setAlpha4parentid(9);
            language.setLanguage("ajxlhVE3t3mp7YbxmH9iqsUWa0Jeba0hLpncmFYkbVMdR9LzXL");
            language.setLanguageDescription("LwhsmCro26V0SYixKTGc6Maa4tFB5qilWk055GLrIDDDTlobmn");
            language.setLanguageIcon("yBEgba6zpLdRIPGKryko4LsGH3YQmKPEHlgkHqwpRBcWiNoXYw");
            language.setLanguageType("7lbz4nNRxNFr6qPcwfNkvYNGzVOuiV58");
            Language LanguageTest = languageRepository.save(language);
            map.put("LanguagePrimaryKey", language._getPrimarykey());
            Timezone timezone = new Timezone();
            timezone.setCities("HRpyHzcYUmmEqaLlZAMaZXNKnBp3bOD1NhIar09Xk78YFuMGZL");
            timezone.setCountry("XXDz07eeqNzTCOUeIKQjx8ajrrVExyls1M0K1r9AFS9c091fSI");
            timezone.setGmtLabel("ZB6gNWJHjhwSO9NFnkIy93z69BWlm8YKWsviLzsxBmcZxfe8WO");
            timezone.setTimeZoneLabel("nXPOZl4HIk0meLiTTTJuJ5Mr0l2wibkT1qE8oKm5etvDFNJp0D");
            timezone.setUtcdifference(8);
            Timezone TimezoneTest = timezoneRepository.save(timezone);
            map.put("TimezonePrimaryKey", timezone._getPrimarykey());
            Title title = new Title();
            title.setTitles("yt9yipcDJeBR77ur6I5xBFDUMzYI81fQBAUSZ9QWB1VI259B5T");
            Title TitleTest = titleRepository.save(title);
            map.put("TitlePrimaryKey", title._getPrimarykey());
            corecontacts.setAge(102);
            corecontacts.setApproximateDOB(new java.sql.Date(123456789));
            corecontacts.setDateofbirth(new java.sql.Date(123456789));
            corecontacts.setEmailId("L1RsOMU24yLLxTeEMTB6pdXluiyzRE5376AxJmD88cT7OYDd5B");
            corecontacts.setFirstName("N68m3g1gKCK12pgimk5QsHa1ynjo4NsoJbWfEAdio8IHszGc2W");
            corecontacts.setGenderId((java.lang.String) GenderTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setLastName("cBT83fEd6w6T7Dig614nlkfSRPCG0SFpQV32wBMAKPH4bc5Epg");
            corecontacts.setMiddleName("UH239eofKTW5fSTUd0whOO1UYj8QeFsxWGuniNqusp91yTuofH");
            corecontacts.setNativeFirstName("igAjabI7qr4wLFLdiGliQEQNZoMl5LuPnGqYGclJl04GJhIwny");
            corecontacts.setNativeLanguageCode((java.lang.String) LanguageTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setNativeLastName("NtsQMqfE8AKow3cL5SUMStDVCKBGglc9mGwn7pRwK4YivD40Tp");
            corecontacts.setNativeMiddleName("vK9RvrNQqXtf3Vke6hDq4poy6GbtFZ7vDZHUeRBkSxnLYNmRa8");
            corecontacts.setNativeTitle("mkjeuwDGEbTWcvJLStXYNtd4th1lHX31aNcp7joXVNsPgjwVWT");
            corecontacts.setPhoneNumber("cXNLo3KNe9KcLYxh0S59");
            ...
            appcustomer.setCustomerName("s4HUAAZ0nuhqA4uGcbN79lY1JvCYv3yRkxetys56oHi13w9XYc");
    ...
    public void test2Update() {
        try {
            ...
            appcustomer.setCustomerName("cSaIWrQm9hwbfD1ykdTMFKOwdBUiJrw3cGh92fu1vD3IMHh6hb");
            appcustomer.setCustomerStatus(1);
            appcustomer.setEvalTimePeriod(2147483647);
            appcustomer.setUserRequested(2147483647);
