...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("zqSRjuDZBM8LsW3g9fm6sHfZYfrlEyNM");
            country.setCapitalLatitude(5);
            country.setCapitalLongitude(6);
            country.setCountryCode1("KcD");
            country.setCountryCode2("qpJ");
            country.setCountryFlag("wihYTwO5psNTTfoqPvL9dGpkQZeWNtTyFlNPOYyasZRZMpXiAb");
            country.setCountryName("a51KhCT3d5k6yucRBprTv9wbzqL1wfzTtrpKyDOgLBjW7fqe1H");
            country.setCurrencyCode("58T");
            country.setCurrencyName("vyiLRazmddhI1PupvR8Qr1spLqs3PnEv4xKhNJVpKM1bD09R0z");
            country.setCurrencySymbol("V20p4bcOYyucbfshYLOGmiOgzl6haY8a");
            country.setIsoNumeric(1);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("ulRsRMLF2tRkVC1AoZdbcOUCEPgkranjCh1oIlmTeMHBx2qzS7");
            currency.setUnicodeDecimal("25LqmGkjAmN2YIk46lrjCs8Apmtf1eP93dDuggHwLyibfLgyrv");
            currency.setUnicodeHex("jC1tAun4fGrZLPwXk4oPaOkOv2wru8HRvRXULgUwXe9yGX9rjF");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("yCndrUdl9oKPhI9OlIKTLyFgynX8XIsyuFtahDvxYrb9EZegL9");
            currency.setUnicodeDecimal("PRyihDf2wokP3CVcwrtYAkCpUrXedTMZy6IbdUaXpg5ThWB2iB");
            currency.setUnicodeHex("KvWV0WgLjnq45rpS9nVoiytHpODCYIswZkRWkOhoYbudvu6vxh");
