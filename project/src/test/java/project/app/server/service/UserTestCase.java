...
public class UserTestCase {
    ...
    public void test1Save() {
        try {
            ...
            useraccessdomain.setDomainDescription("13AuMfFqjLQXWH99lUBeaeco2agrydtqbeUcob3Jdu9q6op9Y6");
            useraccessdomain.setDomainHelp("IrUVsKKNb33oOVHavzN8PlG4UgW1th0PDSaLQp9dLNSRk4p8Et");
            useraccessdomain.setDomainIcon("GrPpwxmEYURq4KRbZ2FghgBNMy3IeRJ2z4BKHhGI8xv4nbxBj6");
            useraccessdomain.setDomainName("EJIf89lZYuy4yn6fPb976YZG902PcyMhoz4vytjjGpA3Ys4uRJ");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("y7HJCS33EJ4JVTiHoCHGbGtD0Ra9d0cASVftQJeyx5sbTd4slV");
            useraccesslevel.setLevelHelp("SmmG91X5j8vK9ZSdjgwFqeTywfWt89WHIl2W6Og76nHXCjCKVk");
            useraccesslevel.setLevelIcon("RlTHwHiYCSk6vlXZHWybBm6CyJRvlh83oy127qTM26N42hXAHI");
            useraccesslevel.setLevelName("zlppE8IB0OqFoJAzj7Bu1kuFkj9fP6bjlCS4MlrYi2nuBTuCLE");
            ...
            user.setPasswordAlgo("OfWjVjbGu5BlcQjyyZSLKJg6UxZsco7yKyt4F9wf8bPBjBYJmY");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(1701);
            user.setUserAccessCode(4);
            user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
            user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
            java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
            PassRecovery passrecovery = new PassRecovery();
            passrecovery.setAnswer("DIs2TqHvdB6yQdZLemQH0Ctw074pdM7fxS96jhlgBolsoMGf4O");
            Question question = new Question();
            question.setLevelid(2);
            question.setQuestion("ZliIqhwRwKKk2LfuL8xann1tx28Jzb8VkLjkPsb0PGsdHMHGOt");
            question.setQuestionDetails("uYR");
            question.setQuestionIcon("JAmhmaiFz1zMIwKFxYJWK3vQ7CenHASe8cOQmgiEjtqw8taCux");
            Question QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
            passrecovery.setAnswer("LUdtHlYFuZXmfQ7BtIESAGm0GidEAnPS9Q5FVi2oCNF0xCt43T");
