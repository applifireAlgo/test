...
public class WebInitializer implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        String solrHome = getSolrHomeDir(servletContext);
        boolean isSolrHomeExist = isSolrHomeExistOrNot(solrHome);
        if (isSolrHomeExist) {
            setSystemProperty("solr.solr.home", solrHome);
    ...
    public String getSolrHome() {
        return "/home/applifire/workspace/YT4U4ZCSDCBW1FGABRGA/salesforceSolr-4.9.0";
    }
