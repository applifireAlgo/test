package salesforce.app.server.businessservice.aspect;
...
public class BusinessAspect {
    ...
    @Before("execution(* salesforce.app.server.repository.*Impl.save(..))")
    public void beforeSaveAdvice(JoinPoint joinPoint) throws SpartanConstraintViolationException {
        Object obj[] = joinPoint.getArgs();
    }

    @After("execution(* salesforce.app.server.businessservice..*(..))")
