...
public class AppCustomerTypeRepositoryImpl extends SearchInterfaceImpl implements AppCustomerTypeRepository<AppCustomerType> {
    ...
    public List<AppCustomerType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<salesforce.app.shared.customers.AppCustomerType> query = emanager.createQuery("select u from AppCustomerType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppCustomerType> save(List<AppCustomerType> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                salesforce.app.shared.customers.AppCustomerType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            salesforce.app.shared.customers.AppCustomerType s = emanager.find(salesforce.app.shared.customers.AppCustomerType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppCustomerType findById(String appcustTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            salesforce.app.shared.customers.AppCustomerType listOfAppCustomerType = (salesforce.app.shared.customers.AppCustomerType) query.getSingleResult();
