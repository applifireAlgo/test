package salesforce.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* salesforce.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* salesforce.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* salesforce.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* salesforce.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* salesforce.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* salesforce.app.server.repository..*(..))")
