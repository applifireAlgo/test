...
public abstract class DistrictService {
    ...
    public HttpEntity<ResponseBean> save(District entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> save(List<District> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
    ...
    public HttpEntity<ResponseBean> update(District entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> update(List<District> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
