...
import salesforce.app.server.repository.PasswordPolicyRepository;
...
public class PasswordPolicyServiceImpl extends PasswordPolicyService {
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody PasswordPolicy entity) throws SpartanPersistenceException, Exception {
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<PasswordPolicy> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            passwordPolicyrepo.save(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody PasswordPolicy entity) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<PasswordPolicy> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            passwordPolicyrepo.update(entity);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            salesforce.app.shared.authentication.PasswordPolicy lstpasswordpolicy = passwordPolicyrepo.findById((String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstpasswordpolicy);
        } catch (org.springframework.transaction.TransactionException e) {
