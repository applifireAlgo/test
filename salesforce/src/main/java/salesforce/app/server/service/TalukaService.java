...
public abstract class TalukaService {
    ...
    public HttpEntity<ResponseBean> save(Taluka entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> save(List<Taluka> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
    ...
    public HttpEntity<ResponseBean> update(Taluka entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> update(List<Taluka> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
