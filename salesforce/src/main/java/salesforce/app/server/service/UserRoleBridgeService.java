...
public abstract class UserRoleBridgeService {
    ...
    public HttpEntity<ResponseBean> save(UserRoleBridge entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> save(List<UserRoleBridge> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
    ...
    public HttpEntity<ResponseBean> update(UserRoleBridge entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> update(List<UserRoleBridge> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
