package salesforce.app.shared.authentication;
...
import salesforce.app.shared.EntityAudit;
import salesforce.app.shared.SystemInfo;
...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    public boolean equals(Object obj) {
        try {
            salesforce.app.shared.authentication.Login other = (salesforce.app.shared.authentication.Login) obj;
            if (loginPk == null) {
                return false;
