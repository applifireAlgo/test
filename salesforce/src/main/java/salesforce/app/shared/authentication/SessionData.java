...
@Entity
@NamedQueries({ @javax.persistence.NamedQuery(name = "findBySessionKey", query = "select e from SessionData e where e.systemInfo.activeStatus=1 and e.appSessionId=:appSessionId and e.sessionKey =:sessionKey"), @javax.persistence.NamedQuery(name = "deleteAllSessionData", query = "delete from SessionData e where e.systemInfo.activeStatus=1 and e.appSessionId=:appSessionId"), @javax.persistence.NamedQuery(name = "SessionData.findByAppSessionId", query = "select e from SessionData e where e.systemInfo.activeStatus=1 and e.appSessionId=:appSessionId") })
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {
    ...
    public boolean equals(Object obj) {
        try {
            salesforce.app.shared.authentication.SessionData other = (salesforce.app.shared.authentication.SessionData) obj;
            if (dataId == null) {
                return false;
