package salesforce.app.shared.customers;
...
public class AppCustomer implements Serializable, CommonEntityInterface, Comparator<AppCustomer> {
    ...
    @NotNull
    private Boolean deploymentModel;
    ...
    @Min(-2147483648L)
    @Max(2147483647)
    private Integer evalTimePeriod;
    ...
    public boolean equals(Object obj) {
        try {
            salesforce.app.shared.customers.AppCustomer other = (salesforce.app.shared.customers.AppCustomer) obj;
            if (appCustomerId == null) {
                return false;
