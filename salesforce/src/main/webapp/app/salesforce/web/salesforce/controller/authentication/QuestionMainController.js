Ext.define('Salesforce.salesforce.web.salesforce.controller.authentication.QuestionMainController', {
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#Question');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down("#Question");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#QuestionTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#Question').down('#' + me.column.dataIndex + '').store;
     ...
     loadData: function(responseData) {
          this.view.down('#Question').getViewModel().setData(responseData.response.data);
     },
