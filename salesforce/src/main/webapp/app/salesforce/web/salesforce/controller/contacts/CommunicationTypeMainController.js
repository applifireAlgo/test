Ext.define('Salesforce.salesforce.web.salesforce.controller.contacts.CommunicationTypeMainController', {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#CommunicationTypeTree');
