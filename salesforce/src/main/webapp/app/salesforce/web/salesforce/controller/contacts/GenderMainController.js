Ext.define('Salesforce.salesforce.web.salesforce.controller.contacts.GenderMainController', {
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#Gender');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down("#Gender");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#GenderTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#Gender').down('#' + me.column.dataIndex + '').store;
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.genderId;
          me = this;
     ...
     loadData: function(responseData) {
          this.view.down('#Gender').getViewModel().setData(responseData.response.data);
     },
