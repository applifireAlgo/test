Ext.define('Salesforce.salesforce.web.salesforce.controller.contacts.TitleMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down("#Title");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#TitleTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#Title').down('#' + me.column.dataIndex + '').store;
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.titleId;
          me = this;
     ...
     loadData: function(responseData) {
          this.view.down('#Title').getViewModel().setData(responseData.response.data);
     },
