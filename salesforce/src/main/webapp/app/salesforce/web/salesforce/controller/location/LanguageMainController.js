Ext.define('Salesforce.salesforce.web.salesforce.controller.location.LanguageMainController', {
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#Language');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down("#Language");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#LanguageTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#Language').down('#' + me.column.dataIndex + '').store;
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.languageId;
          me = this;
     ...
     loadData: function(responseData) {
          this.view.down('#Language').getViewModel().setData(responseData.response.data);
     },
