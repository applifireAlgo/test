Ext.define('Salesforce.salesforce.web.salesforce.controller.location.TimezoneMainController', {
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#Timezone');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down("#Timezone");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#TimezoneTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#Timezone').down('#' + me.column.dataIndex + '').store;
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.timeZoneId;
          me = this;
     ...
     loadData: function(responseData) {
          this.view.down('#Timezone').getViewModel().setData(responseData.response.data);
     },
