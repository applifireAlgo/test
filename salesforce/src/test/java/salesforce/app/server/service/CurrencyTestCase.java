...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("OT7Pv2WucXuttnTixtU3O70nrcGEOAGh");
            country.setCapitalLatitude(3);
            country.setCapitalLongitude(1);
            country.setCountryCode1("kjE");
            country.setCountryCode2("LVG");
            country.setCountryFlag("IcoXNq28OSEbO8aPBIkz3yjEqScCpQi6CHUfaFC9JrvugnjUl6");
            country.setCountryName("monvrd3Tme9EtTi0oOzqNAgHRCReWVUDyZLE68WoT5WkD4PMRc");
            country.setCurrencyCode("RBf");
            country.setCurrencyName("eYLdlxht5itUFFvQrTUbk8J4UKZRev5mkCDSkSAaegcEyQKaNh");
            country.setCurrencySymbol("QArZSYqYqrJnRQWEjlvQP5PPpaAMTkjZ");
            country.setIsoNumeric(9);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("KWu6tVXL9RVRfyd75RSGroBTwSu9vZMXpMdzr7dhtSZar2hHiV");
            currency.setUnicodeDecimal("Q3ENY4hlOIgPZrl8SUvAfD0iaq1bsxfYGFvX5DJAE2kCxWNwij");
            currency.setUnicodeHex("NMgSIEAxJha2BRqaGgw3lwelMLgZeVVcRg5ifXzKIn9EiwvDVP");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("FMcbsfCYRglGrHlhT12UN6IpMz3opb3eHLXIYXCKFydAuXN9A0");
            currency.setUnicodeDecimal("wcErjmXY91XqsT3Fqzh59aACUYMIkx9WqIrPIx34syNsA5nYsl");
            currency.setUnicodeHex("NzDya4UruglrLHCtiTVoRjTBWupmB0eKZg05Q4WOosWdFU6EVd");
