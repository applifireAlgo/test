...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("v9B1TiKQSeoXPHzqdeE27dCOuXl4aStBMIH7QrUOfzgR2rVqf5");
            question.setQuestionDetails("2rJ");
            question.setQuestionIcon("K0iiQnzm6h5P7imXWzFMDN75IW0tuhyxvkCyt87zK9m7KIlQWS");
    ...
    public void test2Update() {
        try {
            ...
            question.setLevelid(0);
            question.setQuestion("d4KM0MSDnkaf6ab7YyMoh5od4qqGdxm0IdyhPuTWhA93J6QZSI");
            question.setQuestionDetails("Alo");
            question.setQuestionIcon("fgEPW73Kaf4cJml07UcCJlt0FITon7JRQysL3fH3xpdPBMY8Dt");
