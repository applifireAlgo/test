...
echo $PATH
OSNAME=`uname -s`
DB_PATH=/tmp/applifire/db/YT4U4ZCSDCBW1FGABRGA
ART_CREATE_PATH=/tmp/applifire/db/YT4U4ZCSDCBW1FGABRGA/art/create
AST_CREATE_PATH=/tmp/applifire/db/YT4U4ZCSDCBW1FGABRGA/ast/create
MYSQL=/usr/bin
APPLFIREUSER=root
