...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/YT4U4ZCSDCBW1FGABRGA/art/data
AST_DATA_PATH=/tmp/applifire/db/YT4U4ZCSDCBW1FGABRGA/ast/data
DB_NAME=applifire
USER=root
PASSWORD=root
PORT=3306
HOST=localhost
MYSQL=/usr/bin
PROJECT_ID=YT4U4ZCSDCBW1FGABRGA
